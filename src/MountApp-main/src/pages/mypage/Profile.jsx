...
export default function Profile({ userProfile: initialProfile = {}, onSave = () => {}, onBack = () => {} }) {
  const userProfile = {
    name: "장민영",
    birth: "2003-04-01",
    gender: "남성",
        ...
        <div className="px-5">
          <div className="flex justify-between items-center mb-4">
            ...
            <ChevronRight className="w-5 h-5 text-gray-400 cursor-pointer" 
              onClick={() => navigate("/mypage/change", { state: { userProfile } })}
            />
          </div>
          <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4 shadow-sm">
            <div className="flex justify-between items-center">
              <span className="text-sm font-bold text-gray-900">이름</span>
              <span className="text-sm text-gray-600">{userProfile?.name ?? "이름 없음"}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm font-bold text-gray-900">생년월일</span>
              <span className="text-sm text-gray-600">{userProfile?.birth ?? "0000-00-00"}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm font-bold text-gray-900">성별</span>
              <span className="text-sm text-gray-600">{userProfile?.gender ?? "정보 없음"}</span>
            </div>
            <div className="flex justify-between items-center">
